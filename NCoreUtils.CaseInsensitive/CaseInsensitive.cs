...
namespace NCoreUtils
{
    ...
    /// </summary>
    public struct CaseInsensitive : IComparable, IConvertible, IEquatable<CaseInsensitive>, IComparable<CaseInsensitive>, IEnumerable<char>
    {
        static readonly StringComparer _cmp = StringComparer.OrdinalIgnoreCase;
        ...
        /// </summary>
        public static readonly CaseInsensitive Empty = CaseInsensitive.Create(string.Empty);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [DebuggerStepThrough]
        public static implicit operator CaseInsensitive(string value) => new CaseInsensitive(value);

        /// <summary>
        /// Determines whether the first instance of <see cref="NCoreUtils.CaseInsensitive"/> is
        /// equal to the second instance of <see cref="NCoreUtils.CaseInsensitive"/>. Two
        ...
        /// </summary>
        /// <param name="a">
        /// Instance of <see cref="NCoreUtils.CaseInsensitive"/> to be compared against.
        /// </param>
        /// <param name="b">
        /// Instance of <see cref="NCoreUtils.CaseInsensitive"/> to be compared against the first one.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Determines whether the first instance of <see cref="NCoreUtils.CaseInsensitive"/> is
        /// inequal to the second instance of <see cref="NCoreUtils.CaseInsensitive"/>. Two
        /// instances are considered equal if underlying values of the instances are equal with
        /// no respect for case-sensitivity or culture.
        /// </summary>
        /// <param name="a">
        ...
        /// <summary>
        /// Determines whether the first instance of <see cref="NCoreUtils.CaseInsensitive"/> is
        /// less than the second instance of <see cref="NCoreUtils.CaseInsensitive"/>.
        /// </summary>
        /// <param name="a">
        /// Instance of <see cref="NCoreUtils.CaseInsensitive"/> to be compared against.
        /// </param>
        ...
        /// <summary>
        /// Determines whether the first instance of <see cref="NCoreUtils.CaseInsensitive"/> is
        /// greater than the second instance of <see cref="NCoreUtils.CaseInsensitive"/>.
        /// </summary>
        /// <param name="a">
        /// Instance of <see cref="NCoreUtils.CaseInsensitive"/> to be compared against.
        /// </param>
        ...
        /// <summary>
        /// Determines whether the first instance of <see cref="NCoreUtils.CaseInsensitive"/> is
        /// less or equal to the second instance of <see cref="NCoreUtils.CaseInsensitive"/>.
        /// </summary>
        /// <param name="a">
        /// Instance of <see cref="NCoreUtils.CaseInsensitive"/> to be compared against.
        /// </param>
        ...
        /// <summary>
        /// Determines whether the first instance of <see cref="NCoreUtils.CaseInsensitive"/> is
        /// greater or equal to the second instance of <see cref="NCoreUtils.CaseInsensitive"/>.
        /// </summary>
        /// <param name="a">
        /// Instance of <see cref="NCoreUtils.CaseInsensitive"/> to be compared against.
        /// </param>
        ...
        /// <see cref="NCoreUtils.CaseInsensitive"/> object.
        /// <para>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [DebuggerStepThrough]
        public CaseInsensitive(string value) => _value = value;
        ...
        /// <summary>
        /// Determines whether the actual instance of <see cref="NCoreUtils.CaseInsensitive"/> is
        /// equal to the specified instance of <see cref="NCoreUtils.CaseInsensitive"/>. Two
        /// instances are considered equal if underlying values of the instances are equal with
        /// no respect for case-sensitivity or culture.
        /// </summary>
        /// <param name="other">
        /// Instance of <see cref="NCoreUtils.CaseInsensitive"/> to be compared against the actual one.
        /// </param>
        /// <returns>
        /// <c>true</c> if the instances are equal; <c>false</c> otherwise.
        /// </returns>
        ...
        /// object is not an instance of <see cref="NCoreUtils.CaseInsensitive"/> the result of
        ...
        /// <summary>
        /// Provides hasing function for the actual instance of <see cref="NCoreUtils.CaseInsensitive"/>.
        ...
        /// <summary>
        /// Compares the actual instance of <see cref="NCoreUtils.CaseInsensitive"/> to
        /// the specified instance of <see cref="NCoreUtils.CaseInsensitive"/>. Compares the underlying
        ...
        /// <see cref="NCoreUtils.CaseInsensitive"/>.
        /// </summary>
        /// <param name="obj">
        /// Object to be compared against the actual one.
        /// </param>
        ...
        /// Thrown if the specified object is not an instance of <see cref="NCoreUtils.CaseInsensitive"/>.
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [DebuggerStepThrough]
        ...
        /// of type <see cref="NCoreUtils.CaseInsensitive"/>.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [DebuggerStepThrough]
        ...
        /// collection of type <see cref="System.String" />, using the specified separator between each member.
        /// </summary>
        ...
        /// <see cref="M:NCoreUtils.CaseInsensitive.Empty" />.
        /// </returns>
        public CaseInsensitive Join(CaseInsensitive separator, IEnumerable<CaseInsensitive> values)
            => CaseInsensitive.Create(string.Join(separator.Value, values.Select(v => v.Value)));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [DebuggerStepThrough]
        public CaseInsensitive Substring(int startIndex) => CaseInsensitive.Create(Value.Substring(startIndex));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [DebuggerStepThrough]
        public CaseInsensitive Substring(int startIndex, int length) => CaseInsensitive.Create(Value.Substring(startIndex, length));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [DebuggerStepThrough]
        public string ToLowerString(CultureInfo cultureInfo) => cultureInfo.TextInfo.ToLower(Value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [DebuggerStepThrough]
        public string ToUpperString(CultureInfo cultureInfo) => cultureInfo.TextInfo.ToUpper(Value);
